...
firstName = "Pat";
lastName = "O'Margarine";
BankCustomer customer3 = new BankCustomer(firstName, lastName);

firstName = "Jerry";
lastName = "Good";
BankRobber villain = new BankRobber(firstName, lastName);
...
Console.WriteLine($"The Villain: {villain.FirstName} {villain.LastName} {villain.CustomerId}");
...
Console.WriteLine($"The Villain's Take: made off with $100,001.95");